...
package struct ScreenScanner {
    package init() {}

    package struct DiscoveredScreen: Hashable {
        package let name: String
        package let source: ScreenSource

        package init(name: String, source: ScreenSource) {
            self.name = name
            self.source = source
        }
    }

    package enum ScreenSource: String, Hashable {
        case tab = "TabView"
    ...
    package func scan(directory: String) -> [DiscoveredScreen] {
