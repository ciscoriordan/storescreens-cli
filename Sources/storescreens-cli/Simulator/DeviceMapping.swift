...
struct AppStoreScreenSize: Codable, Hashable, Sendable {
    let width: Int
    let height: Int
    ...
    var deviceTypeRawValue: String { displayName }
...
struct DeviceMapping {
    ...
    static func readProfile(bundlePath: String) -> (width: Int, height: Int, productFamily: Int)? {
