...
actor SimulatorManager {
    ...
    struct DeviceScreenInfo: Sendable {
        let width: Int
        let height: Int
    ...
    func loadDeviceTypeProfiles() async throws -> [String: DeviceScreenInfo] {
    ...
    func appStoreSize(for device: SimulatorDevice) async throws -> AppStoreScreenSize? {
    ...
    func listAvailableDevices(minimumRuntime: String? = nil) async throws -> [SimulatorDevice] {
    ...
    func findDevice(named name: String) async throws -> SimulatorDevice {
    ...
    func resolveDevices(_ configs: [DeviceConfig]) async throws -> [ResolvedDevice] {
    ...
    func takeScreenshot(_ udid: String, outputPath: String) async throws {
    ...
    func install(_ udid: String, appPath: String) async throws {
    ...
    func launch(_ udid: String, bundleId: String, arguments: [String] = []) async throws {
    ...
    func terminate(_ udid: String, bundleId: String) async throws {
    ...
    func setAppearance(_ appearance: String, udid: String) async throws {
    ...
    func overrideStatusBar(_ udid: String, arguments: String) async throws {
    ...
    func clearStatusBar(_ udid: String) async throws {
    ...
    func disableHardwareKeyboard(_ udid: String) async throws {
    ...
    func setLocale(_ locale: String, udid: String) async throws {
        let prefsPath = NSHomeDirectory()
