...
struct StoreScreensCLI: AsyncParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        subcommands: [ListCommand.self, InitCommand.self, SetupCommand.self, CaptureCommand.self, CheckCommand.self, ScreenshotCommand.self, BezelsCommand.self, RenderCommand.self, AuthCommand.self, SubmitCommand.self, MetadataCommand.self]
    )
