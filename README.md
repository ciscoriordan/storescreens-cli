...
Steps 2-3 are `continue-on-error: true`. A missing or too-narrowly-scoped token emits a warning and a manual command to run, but does not fail the release. The GitHub Release itself (step 1) is fatal on error.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/ciscoriordan/storescreens-cli/star-history/star-history-dark.svg">
  <img alt="Star history chart for ciscoriordan/storescreens-cli" src="https://raw.githubusercontent.com/ciscoriordan/storescreens-cli/star-history/star-history-light.svg" width="100%">
</picture>
